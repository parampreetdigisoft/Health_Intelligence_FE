...
import {
  CountryHistoryDto,
  CountryPillarQuestionHistoryReponseDto,
  GetCountryQuestionHistoryReponseDto,  
  UserCountryRequstDto,
...
export class CountryUserDashboardComponent implements OnInit, OnDestroy {
  ...
  countryLineOptions: any = {};
  isLoader: boolean = false;
  urlBase = environment.apiUrl;
  selectedPillar: CountryPillarQuestionHistoryReponseDto | null = null;
  chooseKpisLayers: boolean = false;
  loading: boolean = false;
  minPillar: CountryPillarQuestionHistoryReponseDto | null = null;
  maxPillar: CountryPillarQuestionHistoryReponseDto | null = null;
  ...
  getCountryQuestionHistory() {
    ...
    let request: UserCountryRequstDto = {
  ...
  pillarChanged(pillar: CountryPillarQuestionHistoryReponseDto) {
    if (pillar?.isAccess) {
