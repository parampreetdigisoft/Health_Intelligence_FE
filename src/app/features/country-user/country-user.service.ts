...
import { CountryHistoryDto, CountryPillarHistoryReponseDto, GetCountriesSubmitionHistoryReponseDto, GetCountryQuestionHistoryReponseDto, UserCountryRequstDto } from 'src/app/core/models/CountryHistoryDto';
...
import { UserCountryGetPillarInfoRequstDto } from './models/UserCountryGetPillarInfoRequstDto';
...
export class CountryUserService {
  ...
  public getAllPillars() {
   ...
   public getCountryUserAllPillars() {
    return this.http.get(`CountryUser/GetAllPillarAsync`).pipe(map(x => x as ResultResponseDto<PillarsVM[]>));
  }
  ...
  public getCountriesProgressByUserId() {
    return this.http.get(`CountryUser/getCountriesProgressByUserId`).pipe(map(x => x as ResultResponseDto<GetCountriesSubmitionHistoryReponseDto[]>));
  }
  public getCountryQuestionHistory(request: UserCountryRequstDto) {
    return this.http.getWithQueryParams(`CountryUser/getCountryQuestionHistory`, request).pipe(map(x => x as GetCountryQuestionHistoryReponseDto));
  }
  ...
  public getCountryDetails(request: UserCountryRequstDto) {
  ...
  public getCountryPillarDetails(request: UserCountryGetPillarInfoRequstDto) {
  ...
  public getAllCountriesByUserId(userId: number) {
    return this.http.get(`CountryUser/getAllCountriesByUserId/` + userId).pipe(map(x => x as ResultResponseDto<CountryVM[]>));;
  }
